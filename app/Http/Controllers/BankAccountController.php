...
class BankAccountController extends Controller
{
    ...
    {
        $data['alldata']= BankAccount::where('branch_id', session('branch_id'))->orderBy('id', 'DESC')->paginate();
        $data['allaccounttype']= AccountType::where('branch_id', session('branch_id'))->get();
