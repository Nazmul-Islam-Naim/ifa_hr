      ...
      <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Deleted Department List</div>
          </div>
          <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td style="width: 20%; text-align:center">
                      <div class="d-flex">
                        ...
                        {{Form::open(array('route'=>['deleted-department-restore',$data->id],'method'=>'PUT'))}}
                          <button type="submit" class="badge bg-success" style="width: 100%">Restore</button>
                        {!! Form::close() !!}
                        {{Form::open(array('route'=>['deleted-department-delete',$data->id],'method'=>'DELETE'))}}
