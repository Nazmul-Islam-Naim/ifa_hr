    ...
    <div class="row gutters">
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        @if(!empty($single_data))
          {!! Form::open(array('route' =>['department.update', $single_data->id],'method'=>'PUT','files'=>true)) !!}
          <?php $info ="Update";?>
        @else
        ...
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{$info}} Department</div>
          </div>
          <div class="card-body">
            <!-- Row start -->
            <div class="row gutters">
              ...
              <table id="dataTable" class="table v-middle">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="actions">
                        <a href="{{ route('department.edit', $data->id) }}" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                          <i class="icon-edit1 text-info"></i>
                        </a>
                        {{Form::open(array('route'=>['department.destroy',$data->id],'method'=>'DELETE'))}}
