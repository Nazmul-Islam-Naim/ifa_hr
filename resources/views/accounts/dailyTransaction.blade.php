          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-12" id="printTable">
                <center><h5 style="margin: 0px">Daily Transaction</h5></center>
                  ...
                  <table class="reportTable" style="width: 100%; font-size: 14px;" cellspacing="0" cellpadding="0">
                    <thead> 
                      <tr style="background: #ccc; color: #000"> 
                        ...
                        <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Receive</th>
                        <th style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">Payment</th>
                    ...
                    <tbody> 
                      ...
                      <tr> 
                        ...
                        <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">{{$data->transactionreport_bank_object->bank_name}}</td>
                        <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px"> 
                          <?php
                            $reasons = $data->reason;
