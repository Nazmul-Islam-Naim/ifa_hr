      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Amount Transfer</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          ...
          <div class="card-body">
            ...
            <div class="field-wrapper">
              ...
              <div class="field-placeholder">Transfer To </div>
            </div>
            <div class="field-wrapper">
              <div class="input-group">
                <input class="form-control" type="number" name="transfer_amount" value="" autocomplete="off" required="">
              </div>
