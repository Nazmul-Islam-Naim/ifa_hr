...
@section('title', 'Other Payment Voucher Report')
@section('content')
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Other Payment Voucher Report</h3>
          ...
          <div class="card-body">
            <div class="col-md-12" id="printTable">
              <center><h5 style="margin: 0px">Other Payment Voucher Report</h5></center>
                ...
                <table class="" style="width: 100%; font-size: 14px;" cellspacing="0" cellpadding="0">  
                  ...
                  <tbody> 
                    ...
                    <tr> 
                      ...
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">{{$data->otherpayment_bank_object->bank_name}}</td>
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">{{$data->otherpayment_type_object->name}}</td>
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">{{$data->otherpayment_subtype_object->name}}</td>
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">{{$data->issue_by}}</td>
                      <td style="font-weight: bold; border: 1px solid #ddd; padding: 3px 3px">{{$data->otherpayment_user_object->name}}</td>
