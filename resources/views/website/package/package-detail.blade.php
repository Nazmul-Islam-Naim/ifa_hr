...
@section('title', 'Smart Hostel | Package Detail')
@section('content')
<div class="container">
  <div class="row"> 
    <!-- Slider -->
    <section class="room-slider standard-slider mt50">
      <div class="col-sm-12 col-md-8">
        <div id="owl-standard" class="owl-carousel">
          <div class="item"> <a href="{{asset('custom/website/images/rooms/slider/room-slider-02.jpg')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('custom/website/images/rooms/slider/room-slider-02.jpg')}}" alt="Bed" class="img-responsive"></a> </div>
          <div class="item"> <a href="{{asset('custom/website/images/rooms/slider/room-slider-03.jpg')}}" data-rel="prettyPhoto[gallery1]"><img src="{{asset('custom/website/images/rooms/slider/room-slider-03.jpg')}}" alt="Bathroom" class="img-responsive"></a> </div>
        </div>
      </div>
    </section>
...
<section class="rooms mt50">
  <div class="container">
    <div class="row">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="{{asset('custom/website/images/rooms/room-01.jpg')}}" alt="room 1" class="img-responsive" />
          <div class="mask">
            <div class="main">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="{{asset('custom/website/images/rooms/room-02.jpg')}}" alt="room 2" class="img-responsive" />
          <div class="mask">
            <div class="main">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="{{asset('custom/website/images/rooms/room-03.jpg')}}" alt="room 3" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>Single room</h5>
