...
@section('title', 'Smart Hostel | Contact')
@section('content')
<!-- GMap -->
<div id="map">
  ...
  <div class="row"> 
    ...
    <section class="contact-details mt50">
      <div class="col-md-4">
        ...
        <a href="{{asset('custom/website/images/contact/contact-01.jpg')}}" data-rel="prettyPhoto"><img src="{{asset('custom/website/images/contact/contact-01.jpg')}}" alt="Our pool" class="img-thumbnail img-responsive"></a>
        <address class="mt50">
