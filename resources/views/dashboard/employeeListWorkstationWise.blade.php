      ...
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card card-primary">
          <div class="card-header d-flex justify-content-between align-items-center">
              <h3 class="card-title">কর্মস্থল অনুযায়ী কর্মকর্তা/কর্মচারীর তালিকা</h3>
              <input type="hidden" value="{{$workstation_id}}" id="workstation_id">
            </div>
          <!-- /.box-header -->
          <div class="card-body">
            <div class="row">
   ...
   function dateFormat(data) { 
    ...
    function filter_view(start_date = '',end_date = '') {
      var table = $('#example').DataTable({
			...
			processing: true,
			ajax: {
        url: "/dashboard/workstation-employee-list/"+id
      },
